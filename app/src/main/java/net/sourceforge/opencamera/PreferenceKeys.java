...
public class PreferenceKeys {
    ...
    public static final String GpsPreferenceKey = "preference_gps";

    public static final String SupportsGpsKey = "supports_gps";
    ...
    public static String getVideoFPSPreferenceKey(int cameraId) {
        // for cameraId==0, we return preference_video_fps instead of
        // preference_video_fps_0, for
