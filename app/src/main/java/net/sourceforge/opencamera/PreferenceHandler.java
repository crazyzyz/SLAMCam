...
public class PreferenceHandler {
    ...
    public boolean isGpsEnabled() {
        return mSharedPreferences.getBoolean(PreferenceKeys.GpsPreferenceKey, true);
    }

    public String getVideoFormat() {
        return mSharedPreferences.getString(PreferenceKeys.VideoFormatPreferenceKey,
                PreferenceKeys.VideoOutputFormatDefaultPreferenceKey);
    }

    public String getImageFormat() {
        return mSharedPreferences.getString(PreferenceKeys.ImageFormatPreferenceKey,
                PreferenceKeys.ImageFormatJpegPreferenceKey);
    }

    /**
     * Retrieves gyroscope and accelerometer sample rate preference and converts it
     * to number.
     */
